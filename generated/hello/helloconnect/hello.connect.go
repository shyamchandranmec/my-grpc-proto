...
type HelloServiceClient interface {
	SayHello(context.Context, *connect.Request[hello.HelloRequest]) (*connect.Response[hello.HelloResponse], error)
}
...
func NewHelloServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HelloServiceClient {
	...
	return &helloServiceClient{
		sayHello: connect.NewClient[hello.HelloRequest, hello.HelloResponse](
			httpClient,
...
type helloServiceClient struct {
	sayHello *connect.Client[hello.HelloRequest, hello.HelloResponse]
}

// SayHello calls hello.HelloService.SayHello.
func (c *helloServiceClient) SayHello(ctx context.Context, req *connect.Request[hello.HelloRequest]) (*connect.Response[hello.HelloResponse], error) {
...
func (UnimplementedHelloServiceHandler) SayHello(context.Context, *connect.Request[hello.HelloRequest]) (*connect.Response[hello.HelloResponse], error) {
